            ...
            <div className='bg-card rounded-xl p-8 metallic-border'>
              ...
              <form onSubmit={handleSubmit} className='space-y-6'>
                ...
                <button
                  ...
                  className='w-full bg-primary text-primary-foreground py-4 px-6 rounded-lg font-semibold text-lg hover:bg-primary/90 transition-all duration-300 flex items-center justify-center space-x-3 metallic-glow disabled:opacity-50 disabled:cursor-not-allowed'
                >
                  {isSubmitting ? (
                    <>
